      ...
      <SidebarInset>
        <header className="flex h-14 items-center gap-2 border-b px-4">
          ...
          <div className="font-semibold flex w-full flex-row items-center gap-2">
            <Label className="truncate text-xl text-primary">
              Enrolment App
            </Label>
        ...
        <footer className="bg-slate-100 flex flex-col gap-1 px-4 text-slate-400 sm:flex-row sm:h-10 sm:items-center sm:px-0 sm:py-0">
